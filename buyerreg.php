...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password === $conpassword) {
        ...
        $query = "INSERT INTO buyerreg (Name, Phone, Email, Password) VALUES ('$name', '$phone', '$email', '$hashed_password')";
        if (mysqli_query($con, $query)) {
            echo "<script>alert('Registration Successful!'); window.location.href = 'buyer.php';</script>";
            exit;
        } else {
...
<body>
    <div class="container mt-5">
        ...
        <form action="buyerreg.php" method="post">
